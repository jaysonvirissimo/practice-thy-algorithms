...
#
# @param height [Array<Integer>] Array of integers representing the height of vertical lines
# @return [Integer] The maximum amount of water a container can store
#
# Example 1:
