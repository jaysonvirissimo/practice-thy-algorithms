...
#
# @param s [String] String consisting of English letters, digits, symbols and spaces
# @return [Integer] Length of the longest substring without repeating characters
#
# Example 1:
# Input: s = "abcabcbb"
# Output: 3
