...
#
# @param s [String] String consisting of only uppercase English letters
# @param k [Integer] Maximum number of character replacements allowed
# @return [Integer] Length of the longest substring with repeating characters after replacements
#
# Example 1:
# Input: s = "ABAB", k = 2
# Output: 4
