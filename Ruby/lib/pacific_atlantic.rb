...
#
# @param heights [Array<Array<Integer>>] 2D matrix where heights[r][c] represents elevation of cell (r,c)
# @return [Array<Array<Integer>>] Array of [row, col] coordinates reachable by both oceans
#
# Example 1:
