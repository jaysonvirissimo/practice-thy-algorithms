...
Args:
    s (str): String consisting of only uppercase English letters
    k (int): Maximum number of character replacements allowed

Returns:
    int: Length of the longest substring with repeating characters after replacements
...
def character_replacement(s, k):
    """
    Find the longest substring with repeating characters after k replacements.
