...
Args:
    s (str): Source string of length m consisting of English letters
    t (str): Target string of length n consisting of English letters
...
def min_window(s, t):
    """
    Find the minimum window substring containing all characters from target string.
